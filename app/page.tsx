  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
      ...
      <section className="relative py-24 px-6 overflow-hidden">
        ...
        {/* Анимированные грузовики на фоне */}
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            {[
              ...
              { icon: Shield, title: "Контроль и надежность", desc: "Система видеонаблюдения и строгое соблюдение WMS-стандартов для сохранности вашего товара." },
            ].map((item, i) => (
              <div key={i} className="group p-8 bg-gradient-to-br from-purple-50 to-orange-50 rounded-3xl shadow-xl hover:shadow-2xl transition-all hover:-translate-y-4">

...
import ContactForm from '@/components/ContactForm'; // Импорт нового компонента

// Иконки и данные для секции Преимуществ (для полноты кода)
const advantageData = [
  {
    icon: Truck,
